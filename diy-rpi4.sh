...
# 更改 Argon 主题背景
cp -f $GITHUB_WORKSPACE/images/5.png package/luci-theme-argon/htdocs/luci-static/argon/img/bg1.jpg
...
sed -i "s/${orig_version}/R${date_version} by Yztz/g" package/lean/default-settings/files/zzz-default-settings
